var PPE2_Mission_2;
(function (PPE2_Mission_2) {
    var mainPPE2_Mission_2 = /** @class */ (function () {
        // Constructeur
        function mainPPE2_Mission_2() {
            var mythis = this;
        ...
        // Bouton Header //
        // ------------- //
        mainPPE2_Mission_2.prototype.generateBoutonHeader = function () {
            var mythis = this;
            // bouton Retour
        ...
        // Corps //
        // ----- //
        mainPPE2_Mission_2.prototype.GenerateContainte = function () {
            var mythis = this;
            var divcontenu = new DivConteneur({ Titre: "PPE2 - Mission 2 Assurance des véhicules des employés de l’agence HsH de VICHY" });
            // Objectif
            ...
            var textObjectif = "Développer une interface de gestion Web des données relatives aux voitures que les commerciaux utilisent lors de leur déplacement. ";
            divcontenu.ajouter(new Label({
                text: textObjectif,
        ...
        Object.defineProperty(mainPPE2_Mission_2.prototype, "x", {
            // Propriete implementer par elementX
            get: function () { return this.page.x; },
            enumerable: true,
            configurable: true
        });
        return mainPPE2_Mission_2;
    }());
    PPE2_Mission_2.mainPPE2_Mission_2 = mainPPE2_Mission_2;
})(PPE2_Mission_2 || (PPE2_Mission_2 = {}));
var PPE2_Mission_2;
(function (PPE2_Mission_2) {
    WebCall.call(function (ici) {
        ici.append(new PPE2_Mission_2.mainPPE2_Mission_2().x);
    });
})(PPE2_Mission_2 || (PPE2_Mission_2 = {}));
