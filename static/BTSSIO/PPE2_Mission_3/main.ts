module PPE2_Mission_3{
    export class mainPPE2_Mission_3 implements ElementX {
        ...
        constructor()
        {
            let mythis : mainPPE2_Mission_3 = this;
        ...
        private GenerateContainte() {
            let mythis: mainPPE2_Mission_3 = this;
            let divcontenu: DivConteneur = new DivConteneur({Titre: "PPE2 - Mission 3 Mise en œuvre d’un PROTOTYPE DE COMPARAISON entre une approche Web et une approche Windows."});
            ...
            let textObjectif: string = "A la suite de l’interface de gestion web des véhicules de l’agence HSH, il est demandé de faire une interface prototype Windows forme pour listé les concessionnaires. "
            divcontenu.ajouter(new Label({
                text: textObjectif,
