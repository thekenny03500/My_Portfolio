var PPE3_Mission_2;
(function (PPE3_Mission_2) {
    var mainPPE3_Mission_2 = /** @class */ (function () {
        // Constructeur
        function mainPPE3_Mission_2() {
            var mythis = this;
        ...
        // Bouton Header //
        // ------------- //
        mainPPE3_Mission_2.prototype.generateBoutonHeader = function () {
            var mythis = this;
            // bouton Retour
        ...
        // Corps //
        // ----- //
        mainPPE3_Mission_2.prototype.GenerateContainte = function () {
            var mythis = this;
            var divcontenu = new DivConteneur({ Titre: "PPE3 - Mission 2 Maintenance EVOLUTIVE des applications de saisie de questionnaires (web) et de CREATION DYNAMIQUE D’UNE INTERFACE (C#) à partir d’un document XML pour la société ALLIER TESTS" });
            // Objectif
        ...
        Object.defineProperty(mainPPE3_Mission_2.prototype, "x", {
            // Propriete implementer par elementX
            get: function () { return this.page.x; },
            enumerable: true,
            configurable: true
        });
        return mainPPE3_Mission_2;
    }());
    PPE3_Mission_2.mainPPE3_Mission_2 = mainPPE3_Mission_2;
})(PPE3_Mission_2 || (PPE3_Mission_2 = {}));
var PPE3_Mission_2;
(function (PPE3_Mission_2) {
    WebCall.call(function (ici) {
        ici.append(new PPE3_Mission_2.mainPPE3_Mission_2().x);
    });
})(PPE3_Mission_2 || (PPE3_Mission_2 = {}));
