var Stage_S2SIO;
(function (Stage_S2SIO) {
    var mainStage_S2SIO = /** @class */ (function () {
        // Constructeur
        function mainStage_S2SIO() {
            var mythis = this;
        ...
        // Bouton Header //
        // ------------- //
        mainStage_S2SIO.prototype.generateBoutonHeader = function () {
            var mythis = this;
            // bouton Retour
        ...
        // Corps //
        // ----- //
        mainStage_S2SIO.prototype.GenerateContainte = function () {
            var mythis = this;
            var divcontenu = new DivConteneur({ Titre: "Stage - Deuxième Année - Cs3i" });
            // Objectif
        ...
        Object.defineProperty(mainStage_S2SIO.prototype, "x", {
            // Propriete implementer par elementX
            get: function () { return this.page.x; },
            enumerable: true,
            configurable: true
        });
        return mainStage_S2SIO;
    }());
    Stage_S2SIO.mainStage_S2SIO = mainStage_S2SIO;
})(Stage_S2SIO || (Stage_S2SIO = {}));
var Stage_S2SIO;
(function (Stage_S2SIO) {
    WebCall.call(function (ici) {
        ici.append(new Stage_S2SIO.mainStage_S2SIO().x);
    });
})(Stage_S2SIO || (Stage_S2SIO = {}));
