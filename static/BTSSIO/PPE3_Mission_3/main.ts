module PPE3_Mission_3{
    export class mainPPE3_Mission_3 implements ElementX {
        ...
        constructor()
        {
            let mythis : mainPPE3_Mission_3 = this;
        ...
        private GenerateContainte() {
            let mythis: mainPPE3_Mission_3 = this;
            let divcontenu: DivConteneur = new DivConteneur({Titre: "PPE3 - Mission 3 Conception et mise en œuvre d’un COMPOSANT UTILITAIRE DE GESTION DE PROCEDURES STOCKEES MySQL depuis une interface C#"});
            ...
            let textObjectif: string = "La société DIMP (« Développement informatique Midi-Pyrénées ») est une SSII régionale implantée à MURET (Haute-Garonne). Depuis " +
