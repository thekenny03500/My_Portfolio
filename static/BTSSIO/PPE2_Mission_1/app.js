var PPE2_Mission_1;
(function (PPE2_Mission_1) {
    var mainPPE2_Mission_1 = /** @class */ (function () {
        // Constructeur
        function mainPPE2_Mission_1() {
            var mythis = this;
        ...
        // Bouton Header //
        // ------------- //
        mainPPE2_Mission_1.prototype.generateBoutonHeader = function () {
            var mythis = this;
            // bouton Retour
        ...
        // Corps //
        // ----- //
        mainPPE2_Mission_1.prototype.GenerateContainte = function () {
            var mythis = this;
            var divcontenu = new DivConteneur({ Titre: "PPE2 - Mission 1 Diagnostic, maintenance corrective et evolutive pour la société immobilière HsH (Home Sweet Home)" });
            // Objectif
            ...
            var textObjectif = "Diagnostiquer puis effectuée une maintenance corrective et évolutive sur les jeux développés pour le Comité d’entreprise du siège social de HsH.";
            divcontenu.ajouter(new Label({
                text: textObjectif,
        ...
        Object.defineProperty(mainPPE2_Mission_1.prototype, "x", {
            // Propriete implementer par elementX
            get: function () { return this.page.x; },
            enumerable: true,
            configurable: true
        });
        return mainPPE2_Mission_1;
    }());
    PPE2_Mission_1.mainPPE2_Mission_1 = mainPPE2_Mission_1;
})(PPE2_Mission_1 || (PPE2_Mission_1 = {}));
var PPE2_Mission_1;
(function (PPE2_Mission_1) {
    WebCall.call(function (ici) {
        ici.append(new PPE2_Mission_1.mainPPE2_Mission_1().x);
    });
})(PPE2_Mission_1 || (PPE2_Mission_1 = {}));
