var PPE2_Mission_4;
(function (PPE2_Mission_4) {
    var mainPPE2_Mission_4 = /** @class */ (function () {
        // Constructeur
        function mainPPE2_Mission_4() {
            var mythis = this;
        ...
        // Bouton Header //
        // ------------- //
        mainPPE2_Mission_4.prototype.generateBoutonHeader = function () {
            var mythis = this;
            // bouton Retour
        ...
        // Corps //
        // ----- //
        mainPPE2_Mission_4.prototype.GenerateContainte = function () {
            var mythis = this;
            var divcontenu = new DivConteneur({ Titre: "PPE2 - Mission 4 Maintenance EVOLUTIVE (nouvelles fonctionnalités, puis évolution vers une approche OBJET) du jeu de POKER pour le Comité d’entreprise du groupe HsH " });
            // Objectif
            ...
            var textObjectif = "Faire Evoluer le jeu de Poker de la mission 1, pour que le jeu soit en approche objet. ";
            divcontenu.ajouter(new Label({
                text: textObjectif,
        ...
        Object.defineProperty(mainPPE2_Mission_4.prototype, "x", {
            // Propriete implementer par elementX
            get: function () { return this.page.x; },
            enumerable: true,
            configurable: true
        });
        return mainPPE2_Mission_4;
    }());
    PPE2_Mission_4.mainPPE2_Mission_4 = mainPPE2_Mission_4;
})(PPE2_Mission_4 || (PPE2_Mission_4 = {}));
var PPE2_Mission_4;
(function (PPE2_Mission_4) {
    WebCall.call(function (ici) {
        ici.append(new PPE2_Mission_4.mainPPE2_Mission_4().x);
    });
})(PPE2_Mission_4 || (PPE2_Mission_4 = {}));
