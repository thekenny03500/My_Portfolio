var PPE3_Mission_4;
(function (PPE3_Mission_4) {
    var mainPPE3_Mission_4 = /** @class */ (function () {
        // Constructeur
        function mainPPE3_Mission_4() {
            var mythis = this;
        ...
        // Bouton Header //
        // ------------- //
        mainPPE3_Mission_4.prototype.generateBoutonHeader = function () {
            var mythis = this;
            // bouton Retour
        ...
        // Corps //
        // ----- //
        mainPPE3_Mission_4.prototype.GenerateContainte = function () {
            var mythis = this;
            var divcontenu = new DivConteneur({ Titre: "PPE3 - Mission 4 Conception et mise en œuvre d’une fonctionnalité « pilote » (la FACTURATION) de la future " +
            ...
            var textObjectif = "Créer une application windows form pour faire des factures et les savegarder.";
            divcontenu.ajouter(new Label({
                text: textObjectif,
                type: EnumTypeLabel.Standard
            }));
        ...
        Object.defineProperty(mainPPE3_Mission_4.prototype, "x", {
            // Propriete implementer par elementX
            get: function () { return this.page.x; },
            enumerable: true,
            configurable: true
        });
        return mainPPE3_Mission_4;
    }());
    PPE3_Mission_4.mainPPE3_Mission_4 = mainPPE3_Mission_4;
})(PPE3_Mission_4 || (PPE3_Mission_4 = {}));
var PPE3_Mission_4;
(function (PPE3_Mission_4) {
    WebCall.call(function (ici) {
        ici.append(new PPE3_Mission_4.mainPPE3_Mission_4().x);
    });
})(PPE3_Mission_4 || (PPE3_Mission_4 = {}));
