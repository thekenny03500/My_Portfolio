module PPE3_Mission_1{
    export class mainPPE3_Mission_1 implements ElementX {
        ...
        constructor()
        {
            let mythis : mainPPE3_Mission_1 = this;
        ...
        private GenerateContainte() {
            let mythis: mainPPE3_Mission_1 = this;
            let divcontenu: DivConteneur = new DivConteneur({Titre: "PPE3 - Mission 1 MAINTENANCE EVOLUTIVE D’UNE APPLICATION DE GESTION POUR LE MUSEE D’ART DES CELESTINS."});
            ...
            let textObjectif: string = "Faire la maintenance évolutive d’un logiciel de gestion de musée."
            divcontenu.ajouter(new Label({
                text: textObjectif,
